...
const agents: Agent[] = [
  {
    id: 'research',
    name: { en: 'Research Agent', ar: 'وكيل البحث' },
    description: { en: 'Deep research and information gathering', ar: 'البحث العميق وجمع المعلومات' },
    icon: '🔬',
    color: 'text-blue-500',
  },
  {
    id: 'analyst',
    name: { en: 'Analysis Agent', ar: 'وكيل التحليل' },
    description: { en: 'Data analysis and insights extraction', ar: 'تحليل البيانات واستخراج الرؤى' },
    icon: '📊',
    color: 'text-purple-500',
  },
  {
    id: 'writer',
    name: { en: 'Writer Agent', ar: 'وكيل الكتابة' },
    description: { en: 'Content creation and editing', ar: 'إنشاء المحتوى وتحريره' },
    icon: '✍️',
    color: 'text-green-500',
  },
  {
    id: 'strategist',
    name: { en: 'Strategy Agent', ar: 'وكيل الاستراتيجية' },
    description: { en: 'Strategic planning and recommendations', ar: 'التخطيط الاستراتيجي والتوصيات' },
    icon: '🎯',
