    ...
    try {
      const { data, error } = await supabase.functions.invoke('ai-chat', {
        body: { 
          messages: [{ 
            role: 'user', 
            content: `You are an expert at crafting effective AI system prompts. Enhance this system prompt to be more comprehensive, clear, and effective while keeping the core intent:
