...
const translations = {
  en: {
    ...
    uploadToGetStarted: 'Upload documents to train your AI assistant',
  ...
  ar: {
    ...
    clickToBrowse: 'أو انقر لتصفح الملفات',
    uploading: 'جاري الرفع',
    loading: 'جاري التحميل',
    uploadedDocuments: 'المستندات المرفوعة',
    uploadToGetStarted: 'ارفع مستندات لتدريب مساعد AI الخاص بك',
